...
// import LeftButtonImage from '../../assets/images/left.png'
import UniverseLogo from '../../assets/images/universe.png'
...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const handleCashbackClaim = () => {
    console.log('Cashback button clicked!!')
  }
  ...
  return (
    <>
      ...
      />
      <NetworkAlert />
      <img src={UniverseLogo} alt={'universe-earth'} width="5%" />
      <h2>Universe/Earth</h2>
      <Row style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        {/* <div style={{ display: 'flex', flexDirection: 'row' }}>
          <StyledNavLink id={`mars-swap`} to={'/mars-swap'}>
            <img src={LeftButtonImage} alt={'mars-swap'} width="60%" />
          </StyledNavLink>
          <Text fontWeight={500} fontSize={20} color={'red'} textAlign={'center'} alignSelf={'center'}>
            <Trans>
              Mars Swap
              <br />
              Coming Soon
        ...
        {/* <div style={{ paddingLeft: 50, paddingRight: 50 }}>
          <ButtonPrimary onClick={handleCashbackClaim}>
